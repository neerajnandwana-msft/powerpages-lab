...
| **Development** | Portal Management App or VS Code + Liquid | Local IDE with standard web tooling |
...
Open the project in your code editor (VS Code or any editor) and explore the structure.
